...
from jacobian import jacobian_double, jacobian_mixed_add_mont, jacobian_to_affine

Gx = 0x79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798
Gy = 0x483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8

# G in Montgomery affine / Jacobian form
G_aff_mont = (
    to_mont(Gx),
    to_mont(Gy)
)
...
# Q = G affine Montgomery
Q = G_aff_mont

# R = 2G + G = 3G
R = jacobian_mixed_add_mont(P, Q)
...
print()
print("Input Q = G affine Montgomery:")
print(f"Q_X2 = 256'h{Q[0]:064x};")
print(f"Q_Y2 = 256'h{Q[1]:064x};")

print()
print("Expected R = 3G Jacobian Montgomery:")
