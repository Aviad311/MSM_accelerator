# run_synthesis_affine_fulltop_axi400_msm200_v1.tcl
# Affine full-top AXI400/MSM200 synthesis flow.
#
# Starts from:
#   synthesis/checkpoints/affine_fulltop_axi400_msm200_v1/
#     affine_fulltop_axi400_msm200_elaborated_constrained_v1.db
#
# Checkpoints are written after every major synthesis phase.
...
set RUN_NAME       "affine_fulltop_axi400_msm200_synthesis_v1"
...
set INPUT_DB   "$CHECKPOINT_DIR/affine_fulltop_axi400_msm200_elaborated_constrained_v1.db"
set GENERIC_DB "$CHECKPOINT_DIR/affine_fulltop_axi400_msm200_after_generic_v1.db"
set MAP_DB     "$CHECKPOINT_DIR/affine_fulltop_axi400_msm200_after_map_v1.db"
set OPT_DB     "$CHECKPOINT_DIR/affine_fulltop_axi400_msm200_after_opt_v1.db"

set FINAL_NETLIST "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi400_msm200_v1.v"
set FINAL_SDC     "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi400_msm200_v1.sdc"
set FINAL_DB      "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi400_msm200_v1.db"
...
puts "============================================================"
puts "Affine full-top AXI400/MSM200 synthesis completed"
puts "TOP:          $TOP_MODULE"
