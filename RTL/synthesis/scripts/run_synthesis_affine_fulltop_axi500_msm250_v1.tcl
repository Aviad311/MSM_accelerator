# run_synthesis_affine_fulltop_axi500_msm250_v1.tcl
...
set RUN_NAME       "affine_fulltop_axi500_msm250_synthesis_v1"
...
set INPUT_DB   "$CHECKPOINT_DIR/affine_fulltop_axi500_msm250_elaborated_constrained_v1.db"
set GENERIC_DB "$CHECKPOINT_DIR/affine_fulltop_axi500_msm250_after_generic_v1.db"
set MAP_DB     "$CHECKPOINT_DIR/affine_fulltop_axi500_msm250_after_map_v1.db"
set OPT_DB     "$CHECKPOINT_DIR/affine_fulltop_axi500_msm250_after_opt_v1.db"

set FINAL_NETLIST "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi500_msm250_v1.v"
set FINAL_SDC     "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi500_msm250_v1.sdc"
set FINAL_DB      "$OUTPUT_DIR/msm_axi_affine_multiwindow_top_dualclk_v1_mapped_axi500_msm250_v1.db"
...
puts "============================================================"
puts "Affine full-top AXI500/MSM250 synthesis completed"
puts "TOP:          $TOP_MODULE"
