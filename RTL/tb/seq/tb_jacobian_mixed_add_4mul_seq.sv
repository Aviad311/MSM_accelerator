...
module tb_jacobian_mixed_add_4mul_seq;
    ...
    logic [WIDTH-1:0] X1, Y1, Z1;
    logic [WIDTH-1:0] X2, Y2;

    logic busy;
    logic done;
    logic [WIDTH-1:0] X3, Y3, Z3;

    always #5 clk = ~clk;

    jacobian_mixed_add_4mul_seq #(
        .WIDTH(WIDTH)
    ) dut (
        .clk   (clk),
        .rst_n (rst_n),
    ...
    initial begin
        ...
        $display("================================================");
        $display(" tb_jacobian_mixed_add_4mul_seq START");
        $display("================================================");
        ...
        $display("================================================");
        $display(" tb_jacobian_mixed_add_4mul_seq PASSED");
        $display("================================================");
