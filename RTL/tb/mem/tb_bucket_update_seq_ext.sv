...
module tb_bucket_update_seq_ext;
    ...
    task automatic do_update_and_check(
        ...
        begin
            ...
            if (last_x !== exp_x || last_y !== exp_y || last_z !== exp_z) begin
                ...
                $fatal(1, "[TB] bucket_update_seq_ext mismatch");
            end else begin
    ...
    initial begin
        ...
        $display("[TB] Starting bucket_update_seq_ext test");
        ...
        $display("[TB] tb_bucket_update_seq_ext PASSED");
        #20;
        $finish;
    end
